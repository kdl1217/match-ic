...
import com.incarcloud.match.config.settings.Swagger2ApiProperties;
import com.incarcloud.match.config.settings.Swagger2AuthorProperties;
 ...
 * Swagger2配置支持
 *
 * @author Aaric, created on 2020-02-26T13:58.
 * @version 0.3.0-SNAPSHOT
 */
public abstract class AbstractSwagger2ConfigSupport {
